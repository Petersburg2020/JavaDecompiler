...
public abstract class AbstractJavaSyntaxVisitor extends AbstractTypeArgumentVisitor implements DeclarationVisitor, ExpressionVisitor, ReferenceVisitor, StatementVisitor, TypeVisitor, TypeParameterVisitor {
    ...
    @Override
    public void visit(@NotNull TypeParameters parameters) {
        for (TypeParameter parameter : parameters) parameter.accept(this);
    }

    public void visit(@NotNull TypeDeclaration declaration) {
        safeAccept(declaration.getAnnotationReferences());
    }

    @Override
    public void visit(@NotNull Types types) {
        for (BaseType type : types) type.accept(this);
    }

    public void acceptListDeclaration(@NotNull List<? extends Declaration> list) {
        for (Declaration declaration : list) declaration.accept(this);
    }

    public void acceptListExpression(@NotNull List<? extends Expression> list) {
        for (Expression expression : list) expression.accept(this);
    }

    public void acceptListReference(@NotNull List<? extends Reference> list) {
        for (Reference reference : list) reference.accept(this);
    }

    public void acceptListStatement(@NotNull List<? extends Statement> list) {
        for (Statement statement : list) statement.accept(this);
    }
    ...
    public void safeAccept(Reference reference) {
        if (reference != null) reference.accept(this);
    }
    ...
    public <D extends Declaration> void safeAcceptListDeclaration(List<D> list) {
        if (list != null)
            for (Declaration declaration : list)
                declaration.accept(this);
    }

    public <S extends Statement> void safeAcceptListStatement(List<S> list) {
        if (list != null)
