...
package nx.peter.lib.jd_core.service.tokenizer.javafragmenttotoken.visitor;
...
public class TokenizeJavaFragmentVisitor implements JavaFragmentVisitor {
    ...
    protected static final List<Token> DO_TOKENS = Collections.singletonList(DO);
    ...
    protected static final List<Token> TRY_TOKENS = Collections.singletonList(TRY);
