...
import nx.peter.lib.jd_core.model.javasyntax.expression.BooleanExpression;
    ...
    public void visit(Statements statements) {
        ...
        if (size > 0) {
            ...
            if (statementCountToRemove > 0) {
                if (!lastFinallyStatementIsATryStatement && (i > 0) && statements.get(i-1).isTryStatement()) {
                    statements.get(i-1).accept(this);
                    statementCountToRemove = 0;
                    i--;
                } else {
