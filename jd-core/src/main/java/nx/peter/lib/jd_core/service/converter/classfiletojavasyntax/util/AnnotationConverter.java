...
import nx.peter.lib.jd_core.model.classfile.attribute.ElementValue;
import nx.peter.lib.jd_core.model.classfile.attribute.ElementValuePair;
...
public class AnnotationConverter implements ElementValueVisitor {
    ...
    protected nx.peter.lib.jd_core.model.javasyntax.reference.ElementValue elementValue = null;
        ...
        if (elementValuePairs == null) {
            ...
            if ("value".equals(elementName)) {
                ...
                return new AnnotationReference(
                        ot,
                        new nx.peter.lib.jd_core.model.javasyntax.reference.ElementValuePair(elementName, convert(elementValue)));
            }
        } else {
            ...
            for (ElementValuePair elementValuePair : elementValuePairs) {
                String elementName = elementValuePair.getElementName();
                ElementValue elementValue = elementValuePair.getElementValue();
                list.add(new nx.peter.lib.jd_core.model.javasyntax.reference.ElementValuePair(elementName, convert(elementValue)));
            }
    ...
    public nx.peter.lib.jd_core.model.javasyntax.reference.ElementValue convert(ElementValue ev) {
        ev.accept(this);
        return elementValue;
    }
