...
package nx.peter.lib.jd_core.service.fragmenter.javasyntaxtojavafragment.visitor;
...
import nx.peter.lib.jd_core.model.javafragment.*;
...
import nx.peter.lib.jd_core.service.fragmenter.javasyntaxtojavafragment.util.CharacterUtil;
import nx.peter.lib.jd_core.service.fragmenter.javasyntaxtojavafragment.util.JavaFragmentFactory;
import nx.peter.lib.jd_core.service.fragmenter.javasyntaxtojavafragment.util.StringUtil;
...
import static nx.peter.lib.jd_core.model.javasyntax.type.PrimitiveType.FLAG_BOOLEAN;
import static nx.peter.lib.jd_core.model.javasyntax.type.PrimitiveType.FLAG_CHAR;
...
public class ExpressionVisitor extends TypeVisitor {
    ...
    protected class HexaExpressionVisitor implements nx.peter.lib.jd_core.model.javasyntax.expression.ExpressionVisitor {
        @Override
        public void visit(IntegerConstantExpression expression) {
            tokens.addLineNumberToken(expression);
