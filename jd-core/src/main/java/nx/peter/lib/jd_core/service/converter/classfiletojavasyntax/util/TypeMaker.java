...
import nx.peter.lib.jd_core.api.loader.LoaderException;
import nx.peter.lib.jd_core.model.classfile.ClassFile;
import nx.peter.lib.jd_core.model.classfile.Field;
import nx.peter.lib.jd_core.model.classfile.Method;
import nx.peter.lib.jd_core.model.classfile.attribute.*;
...
import nx.peter.lib.jd_core.service.converter.classfiletojavasyntax.visitor.BindTypesToTypesVisitor;
import nx.peter.lib.jd_core.service.deserializer.classfile.ClassFileFormatException;
import nx.peter.lib.jd_core.service.deserializer.classfile.ClassFileReader;
...
public class TypeMaker {
    ...
    private final HashMap<String, Type> signatureToType = new HashMap<>(1024);
    private final HashMap<String, Type> internalTypeNameFieldNameToType = new HashMap<>(1024);
    private final HashMap<String, ObjectType> descriptorToObjectType = new HashMap<>(1024);
    private final HashMap<String, ObjectType> internalTypeNameToObjectType = new HashMap<>(1024);
    private final HashMap<String, TypeTypes> internalTypeNameToTypeTypes = new HashMap<>(1024);
    private final HashMap<String, Set<BaseType>> internalTypeNameMethodNameParameterCountToDeclaredParameterTypes = new HashMap<>(1024);
    private final HashMap<String, Set<BaseType>> internalTypeNameMethodNameParameterCountToParameterTypes = new HashMap<>(1024);
    private final HashMap<String, MethodTypes> internalTypeNameMethodNameDescriptorToMethodTypes = new HashMap<>(1024);
    private final HashMap<String, MethodTypes> signatureToMethodTypes = new HashMap<>(1024);

    private final HashMap<Long, Boolean> assignableRawTypes = new HashMap<>(1024);
    private final HashMap<Long, ObjectType> superParameterizedObjectTypes = new HashMap<>(1024);

    private final HashMap<String, String[]> hierarchy = new HashMap<>(1024);
    ...
    private MethodTypes parseMethodSignature(Method method, String key) {
        ...
        methodTypes = attributeSignature == null ? parseMethodSignature(method.getDescriptor(), exceptionTypeNames) : parseMethodSignature(method.getDescriptor(), attributeSignature.getSignature(), exceptionTypeNames);
