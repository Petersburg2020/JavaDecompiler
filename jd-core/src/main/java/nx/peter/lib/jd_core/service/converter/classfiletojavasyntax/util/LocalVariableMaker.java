...
import nx.peter.lib.jd_core.model.javasyntax.declaration.FormalParameters;
...
import nx.peter.lib.jd_core.service.converter.classfiletojavasyntax.model.javasyntax.declaration.ClassFileFormalParameter;
...
import static nx.peter.lib.jd_core.model.classfile.Constants.ACC_ENUM;
import static nx.peter.lib.jd_core.model.classfile.Constants.ACC_STATIC;
import static nx.peter.lib.jd_core.model.javasyntax.declaration.MethodDeclaration.*;
    ...
    protected void initLocalVariablesFromAttributes(Method method) {
        ...
        if (code != null) {
            ...
            if (localVariableTable != null) {
                ...
                for (nx.peter.lib.jd_core.model.classfile.attribute.LocalVariable localVariable : localVariableTable.getLocalVariableTable()) {
