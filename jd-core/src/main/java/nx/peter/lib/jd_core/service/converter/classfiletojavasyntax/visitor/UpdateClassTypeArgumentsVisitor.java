...
import static nx.peter.lib.jd_core.model.javasyntax.type.ObjectType.TYPE_CLASS;
import static nx.peter.lib.jd_core.model.javasyntax.type.ObjectType.TYPE_CLASS_WILDCARD;
...
public class UpdateClassTypeArgumentsVisitor extends AbstractTypeArgumentVisitor {
    ...
    @Override
    public void visit(@NotNull WildcardSuperTypeArgument argument) {
        Type type = argument.getType();
    ...
    @Override
    public void visit(@NotNull ObjectType type) {
