...
import nx.peter.lib.jd_core.service.converter.classfiletojavasyntax.model.javasyntax.declaration.ClassFileLocalVariableDeclarator;
...
import nx.peter.lib.jd_core.service.converter.classfiletojavasyntax.util.PrimitiveTypeUtil;
import nx.peter.lib.jd_core.service.converter.classfiletojavasyntax.util.TypeMaker;
import nx.peter.lib.jd_core.service.converter.classfiletojavasyntax.visitor.CreateLocalVariableVisitor;
import nx.peter.lib.jd_core.service.converter.classfiletojavasyntax.visitor.SearchLocalVariableVisitor;
import nx.peter.lib.jd_core.service.converter.classfiletojavasyntax.visitor.SearchUndeclaredLocalVariableVisitor;
...
public class Frame {
    ...
    public void removeLocalVariable(@NotNull AbstractLocalVariable lv) {
        int index = lv.getIndex();
    ...
    public void createNames(HashSet<String> parentNames) {
        ...
        for (AbstractLocalVariable variable : localVariableArray) {
            AbstractLocalVariable lv = variable;
